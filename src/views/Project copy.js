  ...
  return (
    <div className=" p-5 container">
      <div className="card shadow-lg">
        <div className="card-header pb-1 pt-3 px-5 bg-danger m-0 align-items-center d-flex justify-content-between">
          <p classNameNam="fw-bold">Lorem ipsum dolor sit</p>
